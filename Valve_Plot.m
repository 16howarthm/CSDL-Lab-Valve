...
for a = 1:m
    ...
    Names = [Names,N1,N2,N3,N4,N5,N6,N7,N8];
    NamesP = [NamesP,N1,N2];
    NamesV = [NamesV,N1];
    NamesH = [NamesH,Trial];
...
elseif funcNum == 3 %Hysteresis
    ...
    for i=1:m
        ...
        set(P_H_Plot,'Color',color_array{i});
    end
...
elseif funcNum == 4    %Pressurization and Depressurization Time
    ...
    for i=1:m
        ...
        set(P_G1_Plot,'Color',color_array{i});
        set(P_G2_Plot,'Color',color_array{i});
        set(P_S1_Plot,'Color',color_array{i});
    end
    hold off
...
elseif funcNum == 5 %solenoid step
    ...
    for i=1:m
        ...
        set(P_S_Plot,'Color',color_array{i});
    end
    hold off
...
elseif funcNum == 6 || funcNum == 7
    ...
    for i = 1:m
        ...
        set(P_M1_Plot,'Color',color_array{i});
    end
    hold off
    leg = legend(NamesS,'Location','SouthEast');
    set(leg,'Interpreter', 'none');
    ...
    for i = 1:m
        ...
        set(P_M2_Plot,'Color',color_array{i});
    end
    hold off
    leg = legend(NamesS,'Location','SouthEast');
    set(leg,'Interpreter', 'none');
    ...
    for i = 1:m
        ...
        set(P_M3_Plot,'Color',color_array{i});
    end
    hold off
    leg = legend(NamesS,'Location','SouthEast');
    set(leg,'Interpreter', 'none');
...
elseif funcNum == 9 %solenoid step
    ...
    for i=1:m
        ...
        set(P_M5_Plot,'Color',color_array{i});
    end
    hold off
    leg = legend(NamesP,'Location','SouthEast');
    set(leg,'Interpreter', 'none');
    ...
    for i=1:m
        ...
        set(P_G_Plot,'Color',color_array{i});
    end    
    hold off
    leg = legend(NamesP,'Location','SouthEast');
    set(leg,'Interpreter', 'none');
